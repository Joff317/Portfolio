...
export default function HeroSection() {
  return (
   <div className="flex flex-col gap-1 mx-auto px-2 max-sm:px-0">
   <p className="text-lg text-blue-400">Hello! I'm</p>
   <div className="flex flex-row gap-2 my-2">
     <Image src={businessman} alt="Businessman" className="w-[50px] h-[50px] max-md:w-[40px] max-md:h-[40px]" />
     <p className="text-5xl max-md:text-4xl text-blue-400">Joffrey Freixanet</p>
   </div>
   <p className="text-xl">
     {" "}
